...
export const LightTheme: Theme = {
  theme_name: "Light",
  title: { text: "Цифровой помощник АЦ", type: "text", description: "Title" },
  subtitle: {
    text: "Управление Экспертизы Проектов",
    type: "text",
    description: "Subtitle",
  },
  intro_message: {
    text: "Приветствую! Загрузи документы и задай вопрос!",
    type: "text",
    description: "First Message",
  },
  image: {
    src: "/static/weaviate.png",
    type: "image",
    description: "Logo",
  },
  primary_color: {
...
export const WeaviateTheme: Theme = {
  ...LightTheme,
  theme_name: "Weaviate",
  title: { ...LightTheme.title, text: "Цифровой помощник АЦ" },
  subtitle: { ...LightTheme.subtitle, text: "Управление Экспертизы Проектов" },
  intro_message: {
    ...LightTheme.intro_message,
    text: "Приветствую! Загрузи документы и задай вопрос!",
  },
  ...
  primary_color: { ...LightTheme.primary_color, color: "#113359" },
  secondary_color: { ...LightTheme.secondary_color, color: "#113359" },
  ...
  button_hover_color: { ...LightTheme.button_hover_color, color: "#006fb9" },
